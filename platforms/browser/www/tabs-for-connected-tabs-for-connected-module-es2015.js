...
let TabsForConnectedPageModule = class TabsForConnectedPageModule {
};
...
let TabsForConnectedPage = class TabsForConnectedPage {
    constructor(nameUser) {
        this.nameUser = nameUser;
        this.username = nameUser.theUsername;
    }
};
TabsForConnectedPage.ctorParameters = () => [
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => __webpack_require__.e(/*! import() | parametre-parametre-module */ "parametre-parametre-module").then(__webpack_require__.bind(null, /*! ../parametre/parametre.module */ "./src/app/parametre/parametre.module.ts")).then(m => m.ParametrePageModule)
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => __webpack_require__.e(/*! import() | notif-notif-module */ "notif-notif-module").then(__webpack_require__.bind(null, /*! ../notif/notif.module */ "./src/app/notif/notif.module.ts")).then(m => m.NotifPageModule)
                    }
                ]
            },
            {
...
let TabsForConnectedPageRoutingModule = class TabsForConnectedPageRoutingModule {
};
...
//# sourceMappingURL=tabs-for-connected-tabs-for-connected-module-es2015.js.map